				...
				<div class="wrapper style1">
					<div class="container ouvrage porte">
						<article id="main" class="special">
							<header class="galerie"><p>Cloison intérieur type Atelier d'Artiste</p></header>
							<article>
							...
							<header class="galerie"><p>PMarquise de Style</p></header>
							<article>
								<section class="column-3-md-xs">
							...
							<header class="galerie"><p>Auvant et verrière</p></header>
							<article>
								<section class="column-3-md-xs">
